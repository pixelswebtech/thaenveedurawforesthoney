...
export async function createOrder(userId, orderData) {
  try {
    const orderRef = await addDoc(collection(db, 'orders'), {
      ...
      // Persist delivery and total if provided
      deliveryCharge: typeof orderData.deliveryCharge === 'number' ? orderData.deliveryCharge : 0,
      total: typeof orderData.total === 'number' ? orderData.total : ((typeof orderData.subtotal === 'number' ? orderData.subtotal : 0) + (typeof orderData.deliveryCharge === 'number' ? orderData.deliveryCharge : 0)),
