...
<div className="relative h-[70vh] md:h-[80vh] lg:h-[200vh] w-full overflow-hidden">
<img
src="/home.png"
...
<div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 text-center md:-mt-150">
...
<p className="mt-4 md:-kmt-10 text-base sm:text-lg md:text-xl lg:text-2xl text-pretty max-w-3xl mx-auto text-white">
Wild. Sacred. Real.
<br />
...
<div className="mt-8 md:-mt-0.05 flex flex-col sm:flex-row gap-4 justify-center items-center">
<Link
href="/shop"
